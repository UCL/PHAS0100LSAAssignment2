...
#ifndef pa2MyFunctions_h
#define pa2MyFunctions_h

#include "pa2Win32ExportHeader.h"
#include <vector>

/**
* \file pa2MyFunctions.h
 ...
 * \code{.cpp}
 * double sum = pa2::EvaluateGregoryLeibnizSeries(1, 3);
 * \endcode
 * and to evaluate the 1000th to 2000th term it's:
 * \code{.cpp}
 * double sum = pa2::EvaluateGregoryLeibnizSeries(1000, 2000);
 * \endcode
 *
 ...
 *
 * \code{.cpp}
 * double sum1 = pa2::EvaluateGregoryLeibnizSeries(1, 1000000000);
 * double sum2 = pa2::EvaluateGregoryLeibnizSeries(1000000001, 2000000000);
 * double sum3 = pa2::EvaluateGregoryLeibnizSeries(2000000001, 3000000000);
 * double sum4 = pa2::EvaluateGregoryLeibnizSeries(3000000001, 4000000000);
 * double sum5 = pa2::EvaluateGregoryLeibnizSeries(4000000001, 5000000000);
 * \endcode
 */
PHAS0100LSAASSIGNMENT2_WINEXPORT double EvaluateGregoryLeibnizSeries(unsigned long int startingTermNumber,
 ...
 */
PHAS0100LSAASSIGNMENT2_WINEXPORT double EvaluatePiUsingOpenMP(unsigned long int numberOfElements);
